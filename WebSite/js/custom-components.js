AFRAME.registerComponent("controller", {
    ...
    init: function () {
        ...
        let client;
        let brokerURL = "ws://mqtt.cetools.org:8090";
        // let options = {
        //         username: "student",
        ...
        this.data.disconnect.addEventListener("click", (event) => {
            ...
            this.stopMqtt(client);
        });
        
        //   this.data.remind.addEventListener("click", (event) => {
        //     console.log(event.target.getAttribute("material").color);
        //     this.data.connect.setAttribute("material", { emissiveIntensity: "0.1" });
        //     this.data.disconnect.setAttribute("material", {
        //       emissiveIntensity: "0.8",
    ...
    startMqtt: function (client) {
        client.subscribe('student/CASA0014/plant/ucfntl0/moisture');
        client.subscribe('student/CASA0014/plant/ucfntl0/temperature');
        client.subscribe('student/CASA0014/plant/ucfntl0/humidity')
